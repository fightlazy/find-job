          ...
          <div className="mb-16">
            ...
            <div className="text-muted-foreground">
              <p>
                ...
                Maiores, iste. Quis, molestias voluptates! Ad, officia? Neque
                nisi sed ipsam illo consequuntur, soluta beatae minima eum
                sequi, id cupiditate corrupti error!
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              <div className="flex flex-row justify-between">
                ...
                <div className="font-semibold">July 12, 2024</div>
              </div>
              ...
              <div className="flex flex-row justify-between">
                ...
                <div className="font-semibold">$75k-$89k</div>
              </div>
            </div>
          </div>
        ...
        {[0,1,3].map((item: number) => (
          <div key={item}>
            ...
            <div className="mt-3 text-sm text-gray-500">
              we believe in thriving communities and that starts with our team bening happy and healthy
            </div>
          </div>
        ))}
       </div>
