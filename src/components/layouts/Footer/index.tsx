  ...
  return (
    <div className="bg-slate-900 px-32 pt-16 pb-11">
      ...
      <div className="flex flex-row items-center justify-between">
        <div className="text-slate-600">2024 @jobhunt. All right reserved.</div>
